...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Size = System::Drawing::Size(358, 95);
			this->button1->TabIndex = 0;
			this->button1->Text = L"CLICK ME!!!!!";
			this->button1->UseVisualStyleBackColor = false;
			this->button1->Click += gcnew System::EventHandler(this, &CalendifiedGUI::button1_Click);
			// 
			// CalendifiedGUI
			// 
			...
			this->ClientSize = System::Drawing::Size(490, 373);
